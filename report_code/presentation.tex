...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Target must be inferred from context (often implicit).
    \end{itemize}
...
\begin{itemize}
    \item \textbf{Limitations of Proprietary Models (GPT-4, Claude)}:
    \begin{itemize}
        \item High cost.
        \item Latency issues.
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item \textbf{Excluded}: VAST and ChatGPT datasets (for zero-shot evaluation).
    \end{itemize}
    \item \textbf{Tasks}:
    \begin{itemize}
...
\begin{enumerate}
    ...
    \begin{itemize}
        \item Generates top 3 concise target candidates.
        \item Handles ambiguity in natural language.
    \end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{VAST Implicit}: Zero-shot topics, implicit targets (Most Challenging).
\end{itemize}
\end{frame}
...
\begin{itemize}
    ...
    \begin{itemize}
        \item Single-Stage: Faster but 12\% drop in target accuracy on implicit data.
